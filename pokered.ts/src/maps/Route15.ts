...
export const Route15: Map = {
  ...
  objects: {
    warps: [
      { x: 7, y: 8, toMap: "ROUTE_15_GATE_1F", warpId: 1 },
      { x: 7, y: 9, toMap: "ROUTE_15_GATE_1F", warpId: 2 },
      { x: 14, y: 8, toMap: "ROUTE_15_GATE_1F", warpId: 3 },
      { x: 14, y: 9, toMap: "ROUTE_15_GATE_1F", warpId: 4 }
    ],
