...
export const RockTunnelB1F: Map = {
  ...
  objects: {
    warps: [
      { x: 33, y: 25, toMap: "ROCK_TUNNEL_1F", warpId: 5 },
      { x: 27, y: 3, toMap: "ROCK_TUNNEL_1F", warpId: 6 },
      { x: 23, y: 11, toMap: "ROCK_TUNNEL_1F", warpId: 7 },
      { x: 3, y: 3, toMap: "ROCK_TUNNEL_1F", warpId: 8 }
    ],
    backgroundItems: [],
    objects: [
      {
