...
export const CeladonMansion2F: Map = {
  ...
  objects: {
    warps: [
      { x: 6, y: 1, toMap: MapName.CeladonMansion3F, warpId: 1 },
      { x: 7, y: 1, toMap: MapName.CeladonMansion1F, warpId: 4 },
      { x: 2, y: 1, toMap: MapName.CeladonMansion1F, warpId: 5 },
      { x: 4, y: 1, toMap: MapName.CeladonMansion3F, warpId: 4 }
    ],
    backgroundItems: [
